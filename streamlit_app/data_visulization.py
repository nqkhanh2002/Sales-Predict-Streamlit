...
#data imports
quarter1 = pd.read_csv(quarter_1, low_memory=False)
quarter2 = pd.read_csv(quarter_2, low_memory=False)
quarter3 = pd.read_csv(quarter_3, low_memory=False)
quarter4 = pd.read_csv(quarter_4, low_memory=False)

quarter1_datasales = pd.read_csv(quarter_1_datasales, low_memory=False)
quarter2_datasales = pd.read_csv(quarter_2_datasales, low_memory=False)
quarter3_datasales = pd.read_csv(quarter_3_datasales, low_memory=False)
quarter4_datasales = pd.read_csv(quarter_4_datasales, low_memory=False)